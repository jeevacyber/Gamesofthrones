                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        >
                            ...
                            <div className={`glass-card neon-border p-8 h-full flex flex-col items-center text-center hover:scale-[1.02] transition-transform duration-300 ${round1Locked || round1Completed ? "opacity-70 grayscale" : ""}`}>
                                ...
                                <h2 className="font-cinzel text-2xl font-bold text-cyber-purple mb-4">Round 1</h2>
                                <p className="text-muted-foreground mb-6">
                                    {round1Locked ? "Waiting for Admin Approval" : round1Completed ? "Round Completed! Great job." : "Begin your journey. Prove your skills in the initial trials of the Dragon CTF."}
                                </p>
                                <span className={`w-full mt-auto ${round1Locked || round1Completed ? "btn-secondary cursor-not-allowed" : "btn-cyber"}`}>
                                    {round1Locked ? "Locked" : round1Completed ? "Completed" : "Enter Round 1"}
                                </span>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className={`glass-card neon-border p-8 h-full flex flex-col items-center text-center hover:scale-[1.02] transition-transform duration-300 border-fire-orange/30 ${round2Locked || round2Completed ? "opacity-70 grayscale" : ""}`}>
                                ...
                                <h2 className="font-cinzel text-2xl font-bold text-fire-orange mb-4">Round 2</h2>
                                <p className="text-muted-foreground mb-6">
                                    {round2Locked ? "Waiting for Admin Approval" : round2Completed ? "Round Completed! You have proven your worth." : "The advanced challenges await. Only the worthy may proceed to the final confrontation."}
                                </p>
                                <span className={`w-full mt-auto ${round2Locked || round2Completed ? "btn-secondary cursor-not-allowed" : "btn-fire"}`}>
                                    {round2Locked ? "Locked" : round2Completed ? "Completed" : "Enter Round 2"}
                                </span>
                            </div>
                        </motion.div>
                    </div>
